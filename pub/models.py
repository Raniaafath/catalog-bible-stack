...
class ContentSelection(models.Model):
    ...
    description_user_instructions = models.TextField(blank=True, default="")
    description_ai_enabled = models.BooleanField(default=False)
    description_ai_model = models.CharField(max_length=64, blank=True, default="gpt-4o-mini")
    meta_json = models.JSONField(default=dict, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
